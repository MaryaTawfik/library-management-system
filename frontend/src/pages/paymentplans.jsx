...
const PaymentPlans = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-lg mb-4 text-gray-700">Select a plan that fits your needs</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
        {plans.map((plan) => (
          <div
            key={plan.id}
            className="p-6 border-none rounded-xl shadow hover:shadow-lg transition bg-gray-100"
          > <div className="flex flex-col items-center mb-4">
            ...
            <button
              ...
              className="mt-4 bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-600"
            >
              Choose Plan
            </button>
          </div>
      ...
      <div className="mt-10 p-4 bg-gray-100 border-l-4 border-yellow-500 flex flex-col gap-2 justify-center items-center">
        <h1 className="text-xl font-bold mb-4 align-middle">Payment Instructions</h1>
